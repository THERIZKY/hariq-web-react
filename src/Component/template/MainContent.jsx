		...
		<>
			...
			<div className="main-content">
				<section id="first" className="section-container">
					...
					<img src="/img/bg-3.jpg" className="image-cover" alt="" />
				</section>
				<section id="second" className="section-container ">
					<div className="content about">
						...
						<div className="main" data-aos="zoom-in-up">
							...
							Slimefun Survival Minecraft server in Indonesian!
						</div>
					</div>
					<img src="/img/bg-8.png" className="image-cover" alt="" />
				</section>
			</div>
		</>
	);
